                    ...
                    <div class="inbox-body">
                        ...
                        @else
                            <div class="table-responsive" >
                                                ...
                                                <td>
                                                    @if ($sche->status != 'Approved')
                                                        <div class="btn-group align-top">
                                                            ...
                                                            <button wire:click="deletedId({{ $sche->id }})"
                                                                data-toggle class="btn btn-sm p-2 btn-danger"
                                ...
                                <div class="d-flex">
                                    <div class="mr-auto p-2">showing {{ $items->count() }} of {{ $totalItems }}
                                        entries
                                    </div>
                                    @if ($searchItems == null)
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" wire:model.defer="amount" placeholder="Amount of items "
                        class="form-control
                    @error('amount')
                                                        is-invalid
                    @enderror">
