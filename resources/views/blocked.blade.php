...
<!-- Mirrored from laravel.spruko.com/admitro/Vertical-IconSidedar-Light/construction by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 May 2021 05:58:27 GMT -->
...
<head>
		...
		<!-- Title -->
		<title>Wollo University</title>

		<!--Favicon -->
		<link rel="icon" href="back/assets/images/brand/favicon.png" type="image/x-icon"/>
		...
		<link href="back/assets/plugins/jquery-countdown/jquery.countdown.css" rel="stylesheet" type="text/css">
	...
	<div class="box">
				...
				<div class="container text-center">
					<div class="row">
							...
							<div class="">
								<div class="text-white  ">
									<div class="card-body mt-5" >
										<h2 class="display-3 mb-2 font-weight-bold  error-text"><strong>Your Account Has been Blocked</strong></h2>
										<h4 class="text-white-80 mb-5 text-danger">Contact your Administrator</h4>
						...
						<div class="col-md-6 d-none d-md-flex align-items-center">
							<img src="front/blocked.png" alt="img">
						</div>
					</div>
				</div>
			</div>
		...
		<script src="back/assets/plugins/jquery-countdown/jquery.plugin.min.js"></script>
		<script src="back/assets/plugins/jquery-countdown/jquery.countdown.js"></script>
		<script src="back/assets/plugins/jquery-countdown/countdown.js"></script>
		<!-- Custom js-->
		<script src="back/assets/js/custom.js"></script>	
	</body>

<!-- Mirrored from laravel.spruko.com/admitro/Vertical-IconSidedar-Light/construction by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 May 2021 05:58:28 GMT -->
</html>