    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="index.html">
                ...
                <img src="back/assets/images/brand/favicon.png" class="header-brand-img mobile-logo"
                    alt="Admintro logo">
                <img src="back/assets/images/brand/favicon1.png" class="header-brand-img darkmobile-logo"
                    alt="Admintro logo">
            </a>
