                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome!{{ $user }}
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">We're excited to have you get started. First, you need to confirm your
                                account. Just copy the number below.</p>
                        </td>
                    </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                    <p href="#" target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: 
                                                        #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; 
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center"
                            ...
                            <h2 style="margin: 0;">Thank You for keep touching with us</h2>
